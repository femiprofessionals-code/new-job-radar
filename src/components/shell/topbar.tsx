  ...
  return (
    <header className="sticky top-0 z-30 flex h-14 items-center justify-between gap-3 border-b border-edge bg-canvas/80 px-4 backdrop-blur md:px-6">
      ...
      <div className="flex items-center gap-2">
        {/* Notifications */}
        <Dropdown
          triggerClassName="flex h-9 w-9 items-center justify-center rounded-lg text-ink-muted transition-colors hover:bg-surface-3 hover:text-ink"
          panelClassName="w-80"
          trigger={
        ...
        {/* Account menu */}
        <Dropdown
          triggerClassName="flex items-center gap-2 rounded-lg px-1.5 py-1 transition-colors hover:bg-surface-3"
          panelClassName="w-64"
          trigger={
            <>
